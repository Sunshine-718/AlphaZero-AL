...
class BatchedMCTS:
    ...
    def _predict_batch(self, pv_func, states, action_mask):
        return pv_func.predict(states, action_mask=action_mask)
    ...
    def batch_playout(self, pv_func, current_boards, turns, n_playout=None,
        ...
        if vl_batch <= 1:
            ...
            for step in range(max_n):
                ...
                if non_term_mask.any():
                    ...
                    if self.cache is None:
                        ...
                        non_term_probs, non_term_wdl, non_term_ml = self._predict_batch(
                        ...
                        if miss_indices:
                            ...
                            miss_probs, miss_wdl, miss_ml = self._predict_batch(
            ...
            if remaining > 0:
                ...
                if non_term_mask.any():
                    conv = self._convert_board(leaf_boards[non_term_mask], leaf_turns[non_term_mask])
                    nn_probs, nn_wdl, nn_ml = self._predict_batch(
    ...
    def refresh_cache(self, pv_func):
        ...
        new_probs, new_wdl, new_ml = self._predict_batch(pv_func, states, valid_masks)
