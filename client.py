...
parser.add_argument('--temp_decay_moves', type=int, default=None, help='Moves to keep temp before switching')
parser.add_argument('--temp_endgame', type=float, default=None, help='Temperature after the switch')
